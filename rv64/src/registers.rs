...
pub const X0: regidx = regidx::Regidx(BitVector::new(5, 0));
...
pub const X1: regidx = regidx::Regidx(BitVector::new(5, 1));
...
pub const X2: regidx = regidx::Regidx(BitVector::new(5, 2));
...
pub const X3: regidx = regidx::Regidx(BitVector::new(5, 3));
...
pub const X4: regidx = regidx::Regidx(BitVector::new(5, 4));
...
pub const X5: regidx = regidx::Regidx(BitVector::new(5, 5));
...
///
/// Temporary register in the RISC-V ABI.
pub const X6: regidx = regidx::Regidx(BitVector::new(5, 6));
...
///
/// Temporary register in the RISC-V ABI.
pub const X7: regidx = regidx::Regidx(BitVector::new(5, 7));
...
pub const X8: regidx = regidx::Regidx(BitVector::new(5, 8));
...
pub const X9: regidx = regidx::Regidx(BitVector::new(5, 9));
...
pub const X10: regidx = regidx::Regidx(BitVector::new(5, 10));
...
///
/// Function argument / Return value in the RISC-V ABI.
pub const X11: regidx = regidx::Regidx(BitVector::new(5, 11));
...
pub const X12: regidx = regidx::Regidx(BitVector::new(5, 12));
...
///
/// Function argument in the RISC-V ABI.
pub const X13: regidx = regidx::Regidx(BitVector::new(5, 13));
...
///
/// Function argument in the RISC-V ABI.
pub const X14: regidx = regidx::Regidx(BitVector::new(5, 14));
...
///
/// Function argument in the RISC-V ABI.
pub const X15: regidx = regidx::Regidx(BitVector::new(5, 15));
...
///
/// Function argument in the RISC-V ABI.
pub const X16: regidx = regidx::Regidx(BitVector::new(5, 16));
...
///
/// Function argument in the RISC-V ABI.
pub const X17: regidx = regidx::Regidx(BitVector::new(5, 17));
...
pub const X18: regidx = regidx::Regidx(BitVector::new(5, 18));
...
pub const X19: regidx = regidx::Regidx(BitVector::new(5, 19));
...
pub const X20: regidx = regidx::Regidx(BitVector::new(5, 20));
...
pub const X21: regidx = regidx::Regidx(BitVector::new(5, 21));
...
pub const X22: regidx = regidx::Regidx(BitVector::new(5, 22));
...
pub const X23: regidx = regidx::Regidx(BitVector::new(5, 23));
...
pub const X24: regidx = regidx::Regidx(BitVector::new(5, 24));
...
pub const X25: regidx = regidx::Regidx(BitVector::new(5, 25));
...
pub const X26: regidx = regidx::Regidx(BitVector::new(5, 26));
...
pub const X27: regidx = regidx::Regidx(BitVector::new(5, 27));
...
///
/// Temporary register in the RISC-V ABI.
pub const X28: regidx = regidx::Regidx(BitVector::new(5, 28));
...
///
/// Temporary register in the RISC-V ABI.
pub const X29: regidx = regidx::Regidx(BitVector::new(5, 29));
...
///
/// Temporary register in the RISC-V ABI.
pub const X30: regidx = regidx::Regidx(BitVector::new(5, 30));
...
///
/// Temporary register in the RISC-V ABI.
pub const X31: regidx = regidx::Regidx(BitVector::new(5, 31));
