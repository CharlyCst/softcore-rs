...
impl Core {
    ...
    pub fn get(&mut self, reg: GeneralRegister) -> u64 {
        ...
        raw::rX(self, raw::regno::Regno(reg)).unsigned() as u64
    }
    ...
    pub fn get_single_vec(&mut self, reg: VectorRegister) -> BitDynamic {
...
const fn vlen(config: &raw::Config) -> i128 {
    let vlen_exp = config.extensions.V.vlen_exp;
    return i128::pow(2, vlen_exp as u32);
}
...
pub const fn new_core(config: raw::Config) -> Core {
    Core {
        ...
        pmpaddr_n: [ZEROES; 64],
        vr0: BitDynamic::new(vlen(&config), 0),
        vr1: BitDynamic::new(vlen(&config), 0),
        vr2: BitDynamic::new(vlen(&config), 0),
        vr3: BitDynamic::new(vlen(&config), 0),
        vr4: BitDynamic::new(vlen(&config), 0),
        vr5: BitDynamic::new(vlen(&config), 0),
        vr6: BitDynamic::new(vlen(&config), 0),
        vr7: BitDynamic::new(vlen(&config), 0),
        vr8: BitDynamic::new(vlen(&config), 0),
        vr9: BitDynamic::new(vlen(&config), 0),
        vr10: BitDynamic::new(vlen(&config), 0),
        vr11: BitDynamic::new(vlen(&config), 0),
        vr12: BitDynamic::new(vlen(&config), 0),
        vr13: BitDynamic::new(vlen(&config), 0),
        vr14: BitDynamic::new(vlen(&config), 0),
        vr15: BitDynamic::new(vlen(&config), 0),
        vr16: BitDynamic::new(vlen(&config), 0),
        vr17: BitDynamic::new(vlen(&config), 0),
        vr18: BitDynamic::new(vlen(&config), 0),
        vr19: BitDynamic::new(vlen(&config), 0),
        vr20: BitDynamic::new(vlen(&config), 0),
        vr21: BitDynamic::new(vlen(&config), 0),
        vr22: BitDynamic::new(vlen(&config), 0),
        vr23: BitDynamic::new(vlen(&config), 0),
        vr24: BitDynamic::new(vlen(&config), 0),
        vr25: BitDynamic::new(vlen(&config), 0),
        vr26: BitDynamic::new(vlen(&config), 0),
        vr27: BitDynamic::new(vlen(&config), 0),
        vr28: BitDynamic::new(vlen(&config), 0),
        vr29: BitDynamic::new(vlen(&config), 0),
